...
export default function WeatherCard(props: any) {
	...
	return (
		<div
			className={`aspect-5/6  flex flex-col justify-around pb-32 gap-y-6 h-3/4 absolute top-0 left-0 bottom-0 right-0 m-auto rounded-3xl bg-blue-500 transition-all 
